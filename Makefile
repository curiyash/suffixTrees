menu: suffixTree.o utilities.o queue.o maxLen.o menu.o
	gcc -o menu suffixTree.o utilities.o queue.o maxLen.o menu.o
...
dna: dna.o dnaSuffixTree.o dnaUtilities.o queue.o maxLen.o
	gcc -o dna dna.o dnaSuffixTree.o dnaUtilities.o queue.o maxLen.o
